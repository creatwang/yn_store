...
type Input = { order_id: string; fulfillment_id: string; items?: Array<{ item_id: string; quantity: number }>; labels?: Array<{ tracking_number: string; tracking_url: string; label_url: string }>; no_notification?: boolean }

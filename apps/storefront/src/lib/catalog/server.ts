/** 仅 SSR / Astro 页面：调用 Store API 拉取 catalog */
import { fetchAllPaginated, fetchStoreJson } from "../api"
import type { CatalogCollection, CatalogProduct, CatalogPromotion } from "./types"

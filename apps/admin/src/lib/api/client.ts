...
export const sdk = {
  admin: {
    ...
    featureFlags: {
      list: () => rpcGet((api as any).admin["feature-flags"]),
    },
    translation: {
      list: (query?: Record<string, any>) =>
        rpcGet((api as any).admin.translations, undefined, query),
      batch: (body?: Record<string, unknown>) =>
        rpcPost((api as any).admin.translations.batch, body),
      entities: (query?: Record<string, any>) =>
        rpcGet((api as any).admin.translations.entities, undefined, query),
      settings: (query?: Record<string, any>) =>
        rpcGet((api as any).admin.translations.settings, undefined, query),
      batchSettings: (body?: Record<string, unknown>) =>
        rpcPost((api as any).admin.translations.settings.batch, body),
      statistics: (query?: Record<string, any>) =>
        rpcGet((api as any).admin.translations.statistics, undefined, query),
    },
  },

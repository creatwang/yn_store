...
const numberFieldProps = (onChange: (v: number | null) => void) => ({
...
export const EditInventoryItemAttributesForm = ({
  ...
  const form = useForm<z.infer<typeof EditInventoryItemAttributesSchema>>({
          ...
          <Form.Field
            ...
            render={({ field: { onChange, ...field } }) => (
              <Form.Item>
                ...
                <Form.Control>
                  <Input type="number" {...numberFieldProps(onChange)} {...field} />
                </Form.Control>
                <Form.ErrorMessage />
              </Form.Item>
            )}

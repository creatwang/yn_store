...
> **注意（2026）**：下文部分仍描述「Next.js Admin + 不修改 Medusa 后端」。当前定案以 **[00-agent-handoff.md](00-agent-handoff.md)** 与 **[07-feature-spec.mdx](07-feature-spec.mdx)** 为准：**Hono 自建 API + Vite Admin + Astro storefront**。
